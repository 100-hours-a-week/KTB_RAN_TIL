...
📄 **추천 제목:**
`DNS 요청 흐름과 동작 원리 — 비유로 이해하는 Domain Name System`

📁 **파일명:**
`09_network_dns_request_flow.md`

---

원하면 여기서 **“DNS 요청 과정의 시각적 다이어그램 (Mermaid 구조도)”**
예: 클라이언트 → 리졸버 → Root → TLD → Authoritative → 서버
이 형태로 추가해줄 수도 있어.
(TIL용으로 한눈에 흐름 보여주는 그림처럼)
그 버전도 넣어줄까?
